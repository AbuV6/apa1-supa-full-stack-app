...
<template>
  <form @submit.prevent class="guest-form">
    <label>
      Name:
    ...
    <label>
      Meal Preference:
      <select v-model="form.meal_preference">
    ...
    <label>
      Travelling From:
      <select v-model="form.travelling_from">
...
.guest-form {
  ...
  label {
    ...
    select {
      ...
      &:focus {
        border-color: #ff00ff; // Pink highlight effect
        outline: none;
